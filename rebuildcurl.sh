...
./configure  \
	...
	-enable-shared --enable-static \
	 ...
	 --disable-ldap  --disable-rtsp  --disable-dict --disable-smtp  --disable-manual \
		  ...
		  --disable-imap  --disable-ldaps --disable-pop3 --disable-proxy  --disable-telnet --disable-tftp --disable-zlib --without-ca-bundle --without-gnutls --without-libidn  --without-libssh2 --without-nss --without-zlib --without-random
